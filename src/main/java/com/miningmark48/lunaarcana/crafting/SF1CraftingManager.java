...
public class SF1CraftingManager {

    /** The static instance of this class */
    private static final SF1CraftingManager instance = new SF1CraftingManager();
     ...
     */
    public static final SF1CraftingManager getInstance()
    {
        /** The static instance of this class */
        return instance;
    }

    private SF1CraftingManager()
    {
    ...
    public SF1ShapedRecipes addRecipe(ItemStack p_92103_1_, Object ... p_92103_2_)
    {
        String s = "";
        int i = 0;
        int j = 0;
        ...
        SF1ShapedRecipes shapedrecipes = new SF1ShapedRecipes(j, k, aitemstack, p_92103_1_);
    ...
    public void addShapelessRecipe(ItemStack p_77596_1_, Object ... p_77596_2_)
    {
        ...
        this.recipes.add(new SF1ShapelessRecipes(p_77596_1_, arraylist));
    }
