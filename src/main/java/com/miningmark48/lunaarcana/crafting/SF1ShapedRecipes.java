...
public class SF1ShapedRecipes implements IRecipe{
    ...
    public SF1ShapedRecipes(int p_i1917_1_, int p_i1917_2_, ItemStack[] p_i1917_3_, ItemStack p_i1917_4_)
    {
    ...
    public SF1ShapedRecipes func_92100_c()
    {
