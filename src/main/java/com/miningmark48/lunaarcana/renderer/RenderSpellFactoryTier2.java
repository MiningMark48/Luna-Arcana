...
public class RenderSpellFactoryTier2 extends TileEntitySpecialRenderer{
    ...
    public RenderSpellFactoryTier2(){

        this.model = new ModelSpellFactoryTier2();
    }
    ...
    public void renderTileEntityAt(TileEntity tileEntity, double x, double y, double z, float f) {
        ...
        ResourceLocation texture = new ResourceLocation(Reference.MOD_ID + ":textures/model/spellFactoryTier2.png");
